    ...
    def build_model(self, name):
        ...
        with self._graph.as_default():
            with tf.compat.v1.variable_scope(name):
                ops_dict["learning_rate"] = tf.compat.v1.Variable(self._learning_rate, trainable=False, name="learning_rate")
                ...
                ops_dict["input"] = tf.compat.v1.placeholder(tf.float32, (None,)+self._input_shape, name="inputs")
                ops_dict["dropout_keep_prob"] = tf.compat.v1.placeholder_with_default(1.0,shape=())
                ...
                ops_dict["logits"] = tf.compat.v1.layers.dense(
                    ...
                    activation=None,
                    bias_initializer=tf.constant_initializer(0.1),
                    kernel_regularizer= slim.l2_regularizer(scale=self._regularization_coeff),
                    name="logits")
